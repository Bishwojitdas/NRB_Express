...
/*  static Color getPrimaryColor(BuildContext context) {
  ...
  static const Color COLOR_PRIMARY_RIDER = Color(0xff38B05A);
  static const Color COLOR_PRIMARY = Color(0xffDA0000);
 // static const Color COLOR_PRIMARY = Color(0xff016836);
  ...
  static const Color ORANGE = Color(0xffF44236);
  static const Color PIC_COLOR = Color(0xff006ADC);
  static const Color BACKGROUND_COLOR = Color(0xffdcdcdc);
  static const Color TEXTFIELD_COLOR = Color(0xffF8F7D8);
  static const Color FONT_GREY = Color(0xff616161);
  static const Color Home_bg = Color(0xffE0E0E0);
  static const Color Card_Home = Color(0xffE8E8E8);
  ...
  static const Color RIDER_COLOR = Color(0xff38b05a);
  static const Color RIDER_DRAWER_COLOR1 = Color(0xff539e1b);
  static const Color RIDER_DRAWER_COLOR2 = Color(0xff3c8706);
  static const Color BUTTON_BACKGROUND = Color(0xffdcdcdc);
  static const Color SIGNATURE_BACKGROUND = Color(0xffe9e9e9);
