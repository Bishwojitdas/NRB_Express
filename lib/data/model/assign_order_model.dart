class AssignOrderResponse {
  ...
  late final List<AssignOrderData> data;
  late final Meta meta;
  late final String message;
  late final bool status;

  AssignOrderResponse.fromJson(Map<String, dynamic> json){
    data = List.from(json['data']).map((e)=>AssignOrderData.fromJson(e)).toList();
...
class AssignOrderData {
  ...
  AssignOrderData.fromJson(Map<String, dynamic> json){
    id = json['id'];
    sku = json['sku'];
    sender = json['sender'];
