...
class PendingApprove extends StatefulWidget {
  const PendingApprove({Key? key}) : super(key: key);

  @override
  _PendingApproveState createState() => _PendingApproveState();
}

class _PendingApproveState extends State<PendingApprove> {
  ...
  void initState() {
    ...
    orderController.dateWiseSearch("pending");
    super.initState();
  }
